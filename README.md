...
The site now includes original, non-copyrighted project-owned visual assets in `public/images/` and a central image registry in `content/photos.ts`. These are designed to make the site feel complete during review while avoiding unlicensed stock photography. Replace them with real Panino's food, interior, storefront, staff, and catering photography before launch.
